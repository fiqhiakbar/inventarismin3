...
class PermissionSeeder extends Seeder
{
    ...
    {
        $menuNames = collect(['barang', 'bos', 'ruangan', 'pengguna', 'peminjaman']);
        ...
        $mergedPermissions = $permissions->merge([
            ...
            ['name' => 'import peminjaman', 'guard_name' => 'web', 'created_at' => now(), 'updated_at' => now()],
            ['name' => 'export peminjaman', 'guard_name' => 'web', 'created_at' => now(), 'updated_at' => now()],

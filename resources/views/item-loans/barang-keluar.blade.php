<x-layout>
	<x-slot name="title">Halaman Pengembalian</x-slot>
	<x-slot name="page_heading">Pengembalian</x-slot>
		...
		<div class="card-body">
			...
			<div class="d-flex justify-content-end mb-3">
				<div class="btn-group">
					...
					<form action="{{ route('peminjaman.export', 'keluar') }}" method="POST">
						@csrf
			...
			<div class="row mb-3">
				<div class="col-md-6">
					<form method="GET" action="{{ route('peminjaman.barang-keluar') }}">
				...
				<table class="table table-striped" id="table-1">
					...
					<tbody>
						...
						<tr>
							...
							<td>{{ $item_loan->return_date ? $item_loan->indonesian_format_date($item_loan->return_date) : '-' }}</td>
							<td>
								@can('ubah peminjaman')
	...
	<!-- Create Modal -->
	@include('item-loans.modal.create', ['status' => 'keluar'])

	<!-- Edit Modal -->
	@include('item-loans.modal.edit', ['status' => 'keluar'])

	<!-- Excel Import Modal -->
	@include('item-loans.modal.excel-import', ['status' => 'keluar'])
